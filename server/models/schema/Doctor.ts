...
> {
  ...
  declare setDoctorAppointments: HasManySetAssociationsMixin<Appointment, number>
  declare addDoctorAppointment: HasManyAddAssociationMixin<Appointment, number>
  declare addDoctorAppointments: HasManyAddAssociationsMixin<Appointment, number>
  declare createDoctorAppointment: HasManyCreateAssociationMixin<Appointment>
  declare removeDoctorAppointment: HasManyRemoveAssociationMixin<Appointment, number>
  declare removeDoctorAppointments: HasManyRemoveAssociationsMixin<Appointment, number>
  declare hasDoctorAppointment: HasManyHasAssociationMixin<Appointment, number>
  declare hasDoctorAppointments: HasManyHasAssociationsMixin<Appointment, number>
